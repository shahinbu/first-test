        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-10">
                            {!! Form::open(['url' => 'slider-update','name'=>'edit_category', 'method' => 'POST','enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <input name="description" value="{{$sliderInfo->description }}" class="form-control">
                            </div>
