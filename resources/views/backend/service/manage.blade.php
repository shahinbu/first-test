                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('service/edit')}}/{{$object->id}}"><button class="btn btn-sm btn-success">Edit</button></a> 
                                    | 
                                    <a onclick="return confirm('Are you sure you want to delete this item?')" href="{{url('service/delete')}}/{{$object->id}}">
